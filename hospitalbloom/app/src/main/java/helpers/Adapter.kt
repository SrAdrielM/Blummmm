...
class PacienteAdapter(private val pacientes: List<dataClassPacientes>, private val context: Context, private val medicinas: List<dataClassMedicina>) :
    ...
    private fun showPatientInfoDialog(paciente: dataClassPacientes, medicina: dataClassMedicina) {
        ...
        textViewMedExtra.text = "Medicamento extra: ${paciente.medExtras}"
